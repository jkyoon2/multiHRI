...
def test_different_configurations():
    ...
    configurations = [
        {"layout_name": "cramped_room", "num_agents": 3, "encoding_scheme": "OAI_lossless"},
        {"layout_name": "asymmetric_advantages", "num_agents": 3, "encoding_scheme": "OAI_feats"},
        {"layout_name": "coordination_ring", "num_agents": 4, "reward_type": "shaped"},
    ]
