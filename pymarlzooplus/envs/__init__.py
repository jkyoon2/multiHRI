...
REGISTRY_availability = [
    ...
    "pettingzoo",
    "overcooked",
    "multi_overcooked",  # 3명 이상 에이전트 지원 멀티 오버쿡드
    "pressureplate",
    "capturetarget",
    "boxpushing",
]
...
from pymarlzooplus.envs.multi_overcooked_wrapper import _MultiOvercookedWrapper  # noqa: E402
...
REGISTRY = {
    ...
    "multi_overcooked": partial(env_fn, env=_MultiOvercookedWrapper),  # 멀티 에이전트 3+ 오버쿡드
